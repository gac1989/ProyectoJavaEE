...
public class ComprarJuego extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("El juego es " + ident);
		Game juego = controler.buscarJuego(id);
		String precio = Float.toString(juego.getPrecio());
		
		request.setAttribute("juego", juego.getNombre());
		request.setAttribute("precio", precio);
		request.getRequestDispatcher("WEB-INF/ComprarJuego.jsp").forward(request, response);
	}
